...
export default async function AlumniPage() {
  const doc = await getMarkdownDocHtml("content/alumni.md");
    ...
    <div className="py-12">
      <Container>
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            <h1 className="text-3xl font-semibold tracking-tight">Alumni</h1>
            <p className="mt-2 max-w-2xl text-zinc-600 dark:text-zinc-300">
              졸업생 현황은 `content/alumni.md`에서 관리합니다.
            </p>
          </div>
        ...
        <div className="mt-10">
          {doc ? <Prose html={doc.html} /> : <p>Alumni 문서를 찾을 수 없습니다.</p>}
        </div>
      </Container>
    </div>
  );
